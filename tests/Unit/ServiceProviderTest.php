...
describe('ServiceProvider', function () {
    describe('Basic ServiceProvider Functionality', function () {
    ...
    describe('getConfigPath Method', function () {
    ...
    describe('Configuration and Publishing', function () {
    ...
    describe('Blade Directive Registration', function () {
    ...
    describe('Boot and Register Lifecycle', function () {
