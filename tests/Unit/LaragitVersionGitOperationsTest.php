...
describe('LaragitVersion Git Operations', function () {
    ...
    describe('Git Tags Operations', function () {
    ...
    describe('Repository URL Operations', function () {
    ...
    describe('Commit Hash Operations', function () {
